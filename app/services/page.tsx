...
import { Lightbulb, Home, Building2, Factory, Shield, PenTool } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Complete home electrical solutions including new installations, rewiring, and upgrades."
    },
    {
      icon: <Building2 className="w-10 h-10 text-amber-500" />,
      title: "Commercial Services",
      description: "Electrical systems for offices, retail spaces, and commercial buildings."
    },
    {
      icon: <Factory className="w-10 h-10 text-amber-500" />,
      title: "Industrial Electrical",
      description: "Heavy-duty electrical work for manufacturing and industrial facilities."
    },
    {
      icon: <Lightbulb className="w-10 h-10 text-amber-500" />,
      title: "Lighting Installation",
      description: "Modern lighting solutions for enhanced ambiance and energy efficiency."
    },
    {
    ...
    },
    {
      ...
      description: "Quick and reliable repairs for all electrical issues and regular maintenance."
    }
  ];
    ...
    <section className="relative flex flex-col items-center justify-center min-h-screen w-full text-white py-16">
      ...
      >
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          We provide comprehensive electrical solutions for residential, commercial, and industrial needs with a focus on quality and safety.
        </p>
      </motion.div>
